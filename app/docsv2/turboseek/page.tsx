  ...
  <div className="bg-white border-b border-slate-200 py-2 px-4 sticky top-0 z-50 flex items-center justify-between shadow-sm">
    <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-1 font-extrabold text-slate-900 text-[10px] tracking-tight uppercase">
        ...
        <span className="text-slate-300">/</span>
        <span className="text-emerald-600">Turboseek</span>
      </div>
    </div>
...
export default function TurboseekDocsUltraDense() {
  const [query, setQuery] = useState("bintang");
  ...
  const handleExecute = async () => {
    ...
    try {
      const url = new URL("/api/turboseek", window.location.origin);
    ...
    <div className="min-h-screen bg-[#fafafa] font-sans text-slate-900 selection:bg-sky-200">
      ...
      <main className="max-w-[700px] mx-auto px-4 py-8 space-y-10 pb-20">
        ...
        <section className="space-y-4">
          <div className="inline-flex items-center gap-1.5 px-2 py-0.5 bg-blue-50 border border-blue-100/50 rounded-[4px] text-[7px] font-black text-blue-600 uppercase tracking-[0.2em] shadow-sm">
            <Search className="w-2.5 h-2.5" /> AI SEARCH
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-[20px] font-black text-slate-900 tracking-tight uppercase italic leading-none flex items-center gap-2">
              Turboseek <span className="text-slate-400">Node</span>
            </h1>
          </div>

          <p className="text-[12px] text-slate-600 leading-relaxed max-w-xl pb-2">
            AI-powered search & answer generator. Menggabungkan hasil pencarian dengan penjelasan AI berdasarkan sumber-sumber terkait yang relevan.
          </p>

          <EndpointBox method="GET" url="https://stenly.org/api/turboseek" />
        </section>
            ...
            <div className="space-y-4 flex-1 min-w-0">
              ...
              <div className="space-y-4 w-full pt-1">
                <MicroCodeBlock 
                  ...
                  rawCode={`curl "https://stenly.org/api/turboseek?query=bintang"`}
                  copyId="curl"
                  copied={copied}
                  onCopy={copyCode}
                >
                  <span className="text-emerald-400">curl</span> <span className="text-emerald-300">&quot;https://stenly.org/api/turboseek?query=bintang&quot;</span>
                </MicroCodeBlock>

                <MicroCodeBlock 
                  label="Node.js (Fetch)"
                  rawCode={`const res = await fetch("https://stenly.org/api/turboseek?query=bintang");\nconst data = await res.json();\nconsole.log(data);`}
                  copyId="js"
                  copied={copied}
                  onCopy={copyCode}
                >
                  <span className="text-indigo-400">const</span> res = <span className="text-indigo-400">await</span> <span className="text-sky-400">fetch</span>(<span className="text-emerald-300">&quot;https://stenly.org/api/turboseek?query=bintang&quot;</span>);<br/>
        ...
        <section className="space-y-4 pt-4">
          <div className="flex items-center gap-2 mb-3 border-b border-blue-100 pb-2">
            ...
            <h2 className="text-[10px] font-black text-blue-900 uppercase tracking-widest italic">Hasil Yang Didapatkan (Response)</h2>
          </div>

          <div className="bg-white border border-blue-100 rounded-xl p-5 shadow-sm space-y-6">
            ...
            <div className="space-y-2">
               ...
               <div className="bg-[#050505] rounded-xl p-4 border border-slate-800 shadow-inner overflow-x-auto">
                 <pre className="font-mono font-bold text-[9px] leading-loose">
                   ...
                   <div className="text-blue-500 pl-4">&quot;success&quot;: <span className="text-sky-400">true</span>,</div>
                   <div className="text-blue-500 pl-4">&quot;author&quot;: <span className="text-emerald-300">&quot;Stenly&quot;</span>,</div>
                   <div className="text-blue-500 pl-4">&quot;data&quot;: {"{"}</div>
                   <div className="text-blue-500 pl-8">&quot;query&quot;: <span className="text-emerald-300">&quot;bintang&quot;</span>,</div>
                   <div className="text-blue-500 pl-8">&quot;answer&quot;: <span className="text-emerald-300">&quot;Bintang merupakan benda langit yang memancarkan cahaya...&quot;</span>,</div>
                   <div className="text-blue-500 pl-8">&quot;sources&quot;: [ ... ]</div>
                   <div className="text-blue-500 pl-4">{"}"}</div>
                   <div className="text-blue-500">{"}"}</div>
                 </pre>
               </div>
            </div>
                    ...
                    >
                      <div className="space-y-1.5">
                        ...
                        <div className="text-sky-400 text-[10px] font-bold leading-relaxed border-l-2 border-sky-900/50 pl-3 py-0.5 break-all">
                          https://stenly.org/api/turboseek?query={encodeURIComponent(query)}
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <pre className="text-[10px] font-bold leading-loose p-5 bg-[#0a0a0c] rounded-xl border border-slate-900 shadow-inner">
                          ...
                          &nbsp;&nbsp;<span className="text-indigo-400">&quot;query&quot;</span><span className="text-slate-600">:</span> <span className="text-emerald-500">&quot;{query}&quot;</span><br />
                    ...
                    >
                      ...
                      {isLoading ? (
                         ...
                         <div className="space-y-3">
                           <pre className="text-[10px] font-bold leading-relaxed text-blue-500 bg-[#0a0a0c] p-5 rounded-xl border border-slate-900 shadow-inner overflow-x-auto whitespace-pre-wrap">
